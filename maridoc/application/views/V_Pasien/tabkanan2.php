    ...
    <div class="col-3">
      <div class="border boder-dark">
        <div class="bg-dark text-uppercase text-white text-center px-3 pt-2 pb-1">
          <h6><span class="fa fa-warning pr-2" style="color:red"></span>peringatan</h6>
        </div>
        <div class="py-2 text-justify font-weight-light px-4 my-3" style="font-size:14px">
          <table>  
              <tr>
                <td></td>
                <td>Cek item terlebih dahulu sebelum membayar</td>
              </tr>
              <tr>
                <td></td>
                <td>Jika sudah yakin maka tekan Bayar</td>
              </tr>
              <tr>
                <td></td>
                <td>Kami akan mengirim barang setelah pembayaran telah dilakukan, dan setelah mengonfirmasi pada pihak kami</td>
              </tr>
          </table>
        </div>
      </div>
